...
def ddpg(episode, step, num):
    ...
    for i in range(episode):
        ...
        time_record.append(env.t_all/10)
    ...
    df.to_excel("episode_average_time/episode_average_time_ddpg/episode_average_time_ddpg_{}.xlsx".format(num))
...
def ddpg_local(episode, step, num):
    ...
    df = pd.DataFrame({"Episode": episode_record_step, "Time": time_record_step}).set_index('Episode')
    df.to_excel("episode_average_time/episode_average_time_ddpg_local/episode_average_time_ddpg_local_{}.xlsx".format(num))
...
def ddpg_nogan(episode, step, num):
    ...
    df = pd.DataFrame({"Episode": episode_record_step, "Time": time_record_step}).set_index('Episode')
    df.to_excel("episode_average_time/episode_average_time_ddpg_nogan/episode_average_time_ddpg_nogan_{}.xlsx".format(num))
...
def ddpg_nocache(episode, step, num):
    ...
    df = pd.DataFrame({"Episode": episode_record_step, "Time": time_record_step}).set_index('Episode')
    df.to_excel("episode_average_time/episode_average_time_ddpg_nocache/episode_average_time_ddpg_nocache_{}.xlsx".format(num))
